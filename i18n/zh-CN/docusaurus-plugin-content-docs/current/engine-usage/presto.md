...
本文主要介绍在 Linkis 中，Presto 的部署、使用和配置。
...
mv presto-cli-0.272-executable.jar presto-cli
chmod +x presto-cli
...
方式二：单独编译 Presto 引擎插件（需要有 maven 环境）
